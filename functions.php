 ...
 * Load textdomain.
 */
load_theme_textdomain( 'miljon', get_template_directory() . '/languages' );
...
function air_light_widgets_init() {
  register_sidebar( array(
    'name'          => esc_html__( 'Sidebar', 'miljon' ),
    'id'            => 'sidebar-1',
    'description'   => esc_html__( 'Add widgets here.', 'miljon' ),
...
function air_light_scripts() {
  ...
  wp_localize_script( 'scripts', 'air_light_screenReaderText', array(
    'expand'      => esc_html__( 'Open child menu', 'miljon' ),
